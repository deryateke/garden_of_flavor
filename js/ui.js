...
// Function that will render the menu element.
// Menu elemanı render edecek fonksiyon
const renderMenuCard = (data) => {
  // Iterate over each element in the data received from outside and create an HTML. Set the created HTML as the innerHTML of the menuList within uiElements.
  ...
  uiElements.menuList.innerHTML = data
    ...
    .join("");
  // The data given to the renderMenuCard function is an array. The elements obtained by mapping this array are also an array. When this obtained array is transferred to the interface, the "," between the elements causes a disruption in the interface because array elements are separated by ",". To fix this disrupt
...
const renderDetailPage = (product) => {
  ...
  // Set the HTML content of the detailContainer within uiElements.
...
// Function that will render the not found content when the product is not found.
...
// Function that will render the loader.
